...
#Region "ERRORS"
    Public Shared Sub LogWrite(message As String)
        Dim path As String = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\ShowControl-FFFScreen-Logs"
        If Not IO.Directory.Exists(path) Then
            Dim di As IO.DirectoryInfo = IO.Directory.CreateDirectory(path)
        End If
        Dim file As String = path + "\" + "ShowControl-FFFScreen" + Date.Now.ToString("yyyy-MM-dd") + ".txt"
